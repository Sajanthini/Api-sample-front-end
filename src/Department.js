...
export class Department extends Component {
    ...
    FilterFn(){
        ...
        var filteredData=this.state.departmentWithoutFilter.filter(
            function(el){
    ...
    sortResult(prop,asc){
        var sortedData=this.state.departmentWithoutFilter.sort(function(a,b){
            if(asc){
    ...
    refreshList() {
        ...
        fetch(variables.API_URL + 'department')
            ...
            .then(data => {
                this.setState({ department: data, departmentWithoutFilter:data});
            });
    ...
    /*changeDepartmentName = (e) => {
       // this.setState({ DepartmentName: e.taget.value });
        e.preventDefault();
                            ...
                            <tr key={dep.DepartmentId}>
                                ...
                                <td>
                                    <button type="button"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" classxName="bi bi-pencil-square" viewBox="0 0 16 16">
